...
3. Install Datomic Local (required for database)
   #+begin_example
   # Download from https://docs.datomic.com/on-prem/getting-started/get-datomic.html
   # Extract and configure ~/.datomic/local.edn
   #+end_example
...
** COMMENT Current work plan & progress [43%]
...
**** TODO team domains - auto add user to team
     :LOGBOOK:
...
**** TODO [#A] my actions completion & notes button
     :LOGBOOK:
