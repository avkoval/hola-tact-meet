...
*** TODO Meeting screen (the biggest part) [11%] [1/9]
    :PROPERTIES:
...
**** TODO split updates per meeting!
     :LOGBOOK:
...
**** TODO Prepare to RND today
 ...
 - [ ] "My Actions" page - display my pending actions from all various meetings
 ...
 - [ ] test that appX.koval.kharkov.ua works fine
